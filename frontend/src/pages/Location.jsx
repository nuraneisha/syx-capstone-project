    ...
    return (
        <>
            ...
            <Container fluid className="px-4">
                <Row>
                    <Col md={3}>
                        <Accordion style={{ transform: "translateY(90px)" }}>
                            ...
                            <Accordion.Item eventKey="2">
                                ...
                                <Accordion.Body>
                                    H&M are happy to refund within 30 days for any unsuitable items, provided they are unworn, unwashed and in a resalable condition.
                                    <br /><br />
